  ...
  return (
    <Stack sx={slider}>
      <Stack sx={rib}>
        <Stack sx={slideTrack}>
          <Stack sx={slide} pr={8}>
            <Typography sx={txt}>JavaScript{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} pr={8}>
            <Typography sx={txt}>React JS{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} pr={8}>
            <Typography sx={txt}>Redux{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} ml={-8} pr={8}>
            <Typography sx={txt}>Node JS</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} ml={-3} pr={8}>
            <Typography sx={txt}>Express{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} ml={-4} pr={8}>
            <Typography sx={txt}>Postgress{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} pr={8}>
            <Typography sx={txt}>Sequelize{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} pr={8}>
            <Typography sx={txt}>Git{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} ml={-15} pr={8}>
            <Typography sx={txt}>GitHub{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
          ...
          <Stack sx={slide} ml={-6} pr={8}>
            <Typography sx={txt}>Material UI{''}</Typography>
            <Avatar
              sx={img}
              width="35px"
              height="35px"
